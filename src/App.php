...
namespace Hode\Framework;

use Pimple\Container;
use Hode\Framework\Router;
use Hode\Framework\Response;
use Hode\Framework\Exceptions\HttpException;
use Hode\Framework\Modules\ModuleRegistry;
...
class App {
    ...
    public function getResponder() {
        if (!$this->container->offsetExists('responder')){
            $this->container['responser'] = function ($c) {
                return new Response;
            };
        }

        return $this->container['responser'];
    }
