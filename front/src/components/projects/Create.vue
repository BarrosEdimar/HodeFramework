            ...
            <div v-show="data.title">
                ...
                >
                    ...
                    >
                        ...
                        <v-btn flat color="primary" @click="$refs.menu.save(data.due_date)">Salvar</v-btn>
                    </v-date-picker>                    
                </v-menu>
                ...
                >
                    ...
                    >
                        ...
                        <v-btn flat color="primary" @click="$refs.menuTime.save(due_date_time)">Salvar</v-btn>
                    </v-time-picker>                    
                </v-menu>
